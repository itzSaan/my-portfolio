    ...
    return (
        <section id="Skills" className="skills relative h-full md:h-screen">
            <div className="mx-auto py-6 container  h-full grid place-content-center text-center">               
              ...
              <div className="max-w-5xl lg:my-8 flex flex-wrap justify-center  px-8 gap-4">
               {skills.map( skill => (
                <div key={skill.name} className="w-24 p-3 sm:w-28 xl:w-36 rounded-lg hover:bg-slate-800/50 hover:shadow-xl flex flex-col justify-between gap-4 ">
